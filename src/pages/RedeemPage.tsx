    ...
    <div className="auction-page redeem">
      ...
      <section className="auction-page__hero-full">
        ...
        <div className="auction-page__hero-image">
          ...
          <span className="redeem__presale-badge">Pre Sale</span>
        </div>
      ...
      <div className="auction-page__content-layout">
        <main className="auction-page__main">
          ...
          <section className="auction-page__section">
            ...
            <p className="auction-page__body">
              Participation in the Redeem experience is open to individuals aged 18 years or older (or the legal age of majority in their jurisdiction). Employees of ACCOR, its affiliates, partners...
            </p>
      ...
      <TermsDialog open={termsOpen} onClose={() => setTermsOpen(false)} title="Terms & Conditions (Redeem)" />
    </div>
  );
}
